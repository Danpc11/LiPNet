...
$$\boxed{z_P = z_F \cdot z_R}\qquad \text{pressure load}=\text{flow load}\times\text{resistance load}$$
...
<p align="center">
  <img src="assets/graphical_abstract.png" alt="Graphical abstract: LiPNet, the liver as a dissipation-optimal perfusion network; a partial graft carries a flow load, a resistance load and their product, the pressure load" width="420">
</p>
